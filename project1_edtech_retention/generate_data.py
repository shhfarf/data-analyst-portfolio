"""
Генерация синтетического датасета для проекта "EdTech: анализ оттока и вовлечённости".
Имитирует данные образовательной платформы с потоком 6000+ участников
(по аналогии с реальным опытом: сбор данных, воронка, retention).
"""
import numpy as np
import pandas as pd
